...
class Plugin {
	...
	public static function Settings(GenericEvent $event) {
		...
		$settings->add_dropdown_setting('licenses', 'stock', 'outofstock_licenses_parallels', 'Out Of Stock Parallels Licenses', 'Enable/Disable Sales Of This Type', $settings->get_setting('OUTOFSTOCK_LICENSES_FANTASTICO'), array('0', '1'), array('No', 'Yes', ));
	}
